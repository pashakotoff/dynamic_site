...
<!--                <a href="index.php" class="col-2 btn btn btn-warning">Управление</a>-->
            </div>
            <h2>Управление пользователями</h2>
            <div class="row table-title">
                <div class="id col-1">ID</div>
                <div class="title col-2">Логин</div>
                <div class="title col-3">e-mail</div>
                <div class="edit col-2">Роль</div>
                <div class="edit col-4">Управление</div>
            </div>
            <?php foreach($usersArr as $val):?>
            <div class="row post">
                <div class="id col-1"><?=$val['id']?></div>
                <div class="login col-2"><?=$val['user_name']?></div>
                <div class="email col-3"><?=$val['email']?></div>
                <?php if($val['admin']==1):?>
                    <div class="admin col-2">Admin</div>
                <?php else:?>
                    <div class="admin col-2">User</div>
                <?php endif;?>
                <div class="edit col-2"><a href="edit.php/?id=<?=$val['id']?>">Edit</a></div>
                <div class="del col-2"><a href="edit.php/?del_id=<?=$val['id']?>">Delete</a></div>
            </div>
            <?php endforeach;?>
