            ...
            <div class="row add-post">
                <form action="create.php" method="post">
                    ...
                    <div class="col">
                        ...
                        <input id="category-name" value="<?=$name?>" placeholder="Введите название категории"
                               name="name"
                        type="text"
                               class="form-control"
                    ...
                    <div class="col">
                        ...
                        <textarea id="category-info" placeholder="Введите описание категории"
                                  name="description" class="form-control" id="content" rows="6"><?=$description?></textarea>
                    </div>
                    <div class="col">
                        <button class="btn btn-primary" name="add-topic-btn" type="submit">Создать
                            категорию</button>
                    </div>
                </form>
