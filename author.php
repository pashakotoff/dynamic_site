...
$posts = selectDataForAuthorWithLimit($author_id, $limitOfPostsPerPage, $page);
$numOfActivePosts = countNumOfActivePostsByAuthor($author_id);
...
<div class="container">
    <div class="content row">
        ...
        <div class="main-content col-md-9">
            <h2>Посты автора <strong>"<?php echo $posts[0]['user_name'] ?>"</strong></h2>
