...
<div class="container reg_form">
    <form class="row justify-content-md-center" method="post" action="reg.php">
        ...
        <div class="mb-3 col-12 col-md-4">
            ...
            <input name="login" value="<?=$user_name?>" type="text" class="form-control" id="formGroupExampleInput">
        </div>
        <div class="w-100"></div>
        <div class="mb-3 col-12 col-md-4">
        ...
        <div class="mb-3 col-12 col-md-4">
            ...
            <button type="submit" name="reg-button" class="btn btn-secondary">Зарегистрироваться</button>
